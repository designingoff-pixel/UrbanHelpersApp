...
export interface FoodDefinition {
  id: string;
  name: string;
  aliases?: string[];  // common/alternate search terms e.g. ["dahi", "yogurt"] for Curd
...
export const FOOD_DATABASE: FoodDefinition[] = [
  ...
  // ─── ADDITIONAL COMMONLY SEARCHED FOODS ───

  // South Indian extras
  {
    id: "poha",
    name: "Poha",
    aliases: ["beaten rice", "flattened rice", "aval", "avalakki", "chivda", "chira"],
    category: "South Indian",
    calories: 180,
    unit: "bowl (150 g)",
    grams: 150,
  ...
  },
  {
    id: "appam",
    name: "Appam",
    aliases: ["palappam", "lace appam", "hoppers", "vellayappam"],
    category: "South Indian",
    calories: 120,
    unit: "piece (70 g)",
    grams: 70,
  ...
  },
  {
    id: "puttu",
    name: "Puttu",
    aliases: ["rice puttu", "kadala puttu", "kerala puttu"],
    category: "South Indian",
    calories: 195,
    unit: "piece (120 g)",
    grams: 120,
  ...
  },
  {
    id: "pongal_ven",
    name: "Ven Pongal",
    aliases: ["pongal", "khara pongal", "savoury pongal", "rice pongal"],
    category: "South Indian",
    calories: 210,
    unit: "bowl (180 g)",
    grams: 180,
  ...
  },
  {
    id: "pesarattu",
    name: "Pesarattu",
    aliases: ["moong dal dosa", "green moong dosa", "green gram dosa"],
    category: "South Indian",
    calories: 155,
    unit: "piece (90 g)",
    grams: 90,
  ...
  },
  {
    id: "parotta",
    name: "Parotta",
    aliases: ["kerala parotta", "malabar paratha", "layered parotta", "porotta"],
    category: "South Indian",
    calories: 250,
    unit: "piece (100 g)",
    grams: 100,
  ...
  // Curries & Eggs
  {
    id: "egg_curry",
    name: "Egg Curry",
    aliases: ["boiled egg curry", "anda curry", "mutta curry"],
    category: "Meat & Seafood",
    calories: 185,
    unit: "serving (150 g)",
    grams: 150,
  ...
  },
  {
    id: "fish_curry",
    name: "Fish Curry",
    aliases: ["meen curry", "fish kuzhambu", "seafood curry"],
    category: "Meat & Seafood",
    calories: 160,
    unit: "serving (150 g)",
    grams: 150,
  ...
  },
  {
    id: "prawn_masala",
    name: "Prawn Masala",
    aliases: ["shrimp masala", "prawn curry", "chemmeen masala", "jhinga masala"],
    category: "Meat & Seafood",
    calories: 155,
    unit: "serving (120 g)",
    grams: 120,
  ...
  },
  {
    id: "mutton_curry",
    name: "Mutton Curry",
    aliases: ["lamb curry", "goat curry", "gosht", "mutton gravy"],
    category: "Meat & Seafood",
    calories: 240,
    unit: "serving (150 g)",
    grams: 150,
  ...
  // North Indian mains
  {
    id: "paneer_butter_masala",
    name: "Paneer Butter Masala",
    aliases: ["paneer makhani", "butter paneer", "paneer curry"],
  ...
  },
  {
    id: "rajma",
    name: "Rajma",
    aliases: ["kidney beans curry", "rajma chawal", "red kidney beans"],
    category: "Curries & Dals",
    calories: 195,
    unit: "bowl (200 g)",
    grams: 200,
  ...
  },
  {
    id: "chole",
    name: "Chole",
    aliases: ["chana masala", "chickpea curry", "chhole", "kabuli chana"],
    category: "Curries & Dals",
    calories: 210,
    unit: "bowl (200 g)",
    grams: 200,
  ...
  },
  {
    id: "khichdi",
    name: "Khichdi",
    aliases: ["khichri", "khichadi", "moong dal khichdi", "dal khichdi"],
    category: "North Indian",
    calories: 200,
    unit: "bowl (200 g)",
    grams: 200,
  ...
  },
  {
    id: "vada_pav",
    name: "Vada Pav",
    aliases: ["vada pao", "batata vada pav", "mumbai burger"],
    category: "Snacks & Fast Food",
    calories: 290,
    unit: "piece (150 g)",
    grams: 150,
  ...
  },
  {
    id: "maggi_noodles",
    name: "Maggi Noodles",
    aliases: ["instant noodles", "maggi masala", "2-minute noodles"],
    category: "Snacks & Fast Food",
    brand: "Maggi",
    calories: 340,
    unit: "packet cooked (240 g)",
    grams: 240,
    carbs: 52.0,
    fat: 11.0,
    protein: 7.5,
  ...
  // Biscuits & snack
  {
    id: "marie_biscuit",
    name: "Marie Biscuit",
    aliases: ["marie gold", "marie lite", "plain biscuit"],
    category: "Snacks & Fast Food",
    calories: 35,
    unit: "piece (7 g)",
    grams: 7,
  ...
  },
  {
    ...
    aliases: ["parle g", "glucose biscuit", "parle glucose"],
    category: "Snacks & Fast Food",
    brand: "Parle",
    calories: 38,
    unit: "piece (7.5 g)",
  ...
  // Fruits (additional)
  {
    id: "mango",
    name: "Mango",
    aliases: ["aam", "mangai", "alphonso", "banganapalli", "kesar"],
    category: "Fruits & Veggies",
    calories: 60,
    unit: "cup sliced (100 g)",
    grams: 100,
    carbs: 15.0,
    fat: 0.4,
    protein: 0.8,
  ...
  },
  {
    id: "watermelon",
    name: "Watermelon",
    aliases: ["tarbooz", "kaalinga", "tarbuja"],
    category: "Fruits & Veggies",
    calories: 30,
    unit: "cup cubed (100 g)",
    grams: 100,
    carbs: 7.5,
    fat: 0.2,
    protein: 0.6,
  ...
  // Beverages
  {
    ...
    aliases: ["tea", "indian tea", "masala chai", "cutting chai", "chai"],
    category: "Beverages",
    calories: 60,
    unit: "cup (200 ml)",
    grams: 200,
  ...
  },
  {
    id: "black_coffee",
    name: "Black Coffee",
    aliases: ["filter coffee", "espresso", "americano", "plain coffee"],
    category: "Beverages",
    calories: 5,
    unit: "cup (240 ml)",
    grams: 240,
  ...
  },
  {
    id: "coconut_water",
    name: "Tender Coconut Water",
    aliases: ["coconut water", "thengai panam", "nariyal pani", "elaneer"],
    category: "Beverages",
    calories: 48,
    unit: "cup (240 ml)",
    grams: 240,
  ...
  },
  {
    id: "buttermilk",
    name: "Buttermilk",
    aliases: ["chaas", "mor", "taak", "lassi", "spiced yogurt drink", "curd water"],
    category: "Beverages",
    calories: 35,
    unit: "glass (200 ml)",
    grams: 200,
  ...
  },
  {
    id: "sweet_lassi",
    name: "Sweet Lassi",
    aliases: ["lassi", "mango lassi", "dahi drink", "yogurt smoothie"],
    category: "Beverages",
    calories: 140,
    unit: "glass (250 ml)",
    grams: 250,
  ...
  },
  {
    ...
    aliases: ["protein shake", "protein powder", "whey shake", "gym shake", "protein drink"],
    category: "High Protein",
    calories: 150,
    unit: "scoop in water (300 ml)",
    grams: 300,
    carbs: 5.0,
    fat: 2.5,
    protein: 25.0,
  ...
  // Curd / Dahi — alias-rich entry for common Indian searches
  {
    id: "curd_plain",
    name: "Curd",
    aliases: ["dahi", "yogurt", "yoghurt", "plain curd", "set curd", "thayir"],
    category: "Dairy & Eggs",
    calories: 60,
    unit: "bowl (100 g)",
    grams: 100,
 ...
 * Matches on: name, brand, category, and aliases (alternate/common names).
 */
export function searchFoodDatabase(
  ...
  return FOOD_DATABASE.filter((item) => {
    ...
    const matchesQuery =
      ...
      (item.aliases && item.aliases.some((a) => a.toLowerCase().includes(cleanQ)));
